...
Requires Retail 12.1, QuestWordHunter, and target language **Italian**.

Maintainers: put Blizzard keys in `Tools/keys.env`, QuestV2 CSV in `Data/QuestV2.csv`, then run `Tools/build_all.ps1`.
